...
# ==============================================================================
# Test: Drift Anomaly Detection with Fixed Lambda
# ==============================================================================
...
ANOMALY_CSV="$PROJECT_ROOT/data/Anomaly/output_of_the_1th_chunk__Temperatur_Exzenterlager_links__drift.csv"
GROUND_TRUTH_JSON="$PROJECT_ROOT/data/Anomaly/output_of_the_1th_chunk__Temperatur_Exzenterlager_links__drift.json"
...
RESULTS_BASE_DIR="$PROJECT_ROOT/results/fixed_lambda_drift_test_$(date +%Y%m%d_%H%M%S)"

echo "=============================================================================="
echo "Fixed Lambda Test: DRIFT Anomaly"
...
run_pipeline "$ANOMALY_CSV" "$ANOMALY_RUN_DIR" "false" "Anomaly (Drift)" "$FIXED_LAMBDA_SCRIPT" "$GOLDEN_LAGS_FILE" "false"
...
echo -e "\n=============================================================================="
echo "Running Diagnostics: DRIFT Anomaly"
echo "=============================================================================="
...
python3 "$DIAGNOSTIC_SCRIPT" \
  ...
  --anomaly-type "drift_fixed_lambda" \
