#!/usr/bin/env python3
"""
Test the epicenter detector on all 6 anomaly types
"""
...
def find_ground_truth(anomaly_type):
    ...
    # Common locations - the actual files use format:
    # output_of_the_1th_chunk__Temperatur_Exzenterlager_links__{anomaly_type}.json
    possible_paths = [
...
def main():
    print("="*100)
    print("TESTING EPICENTER DETECTOR ON ALL ANOMALY TYPES")
    print("="*100)
    ...
    for anomaly_type in ANOMALY_TYPES:
        ...
        # Look for processed anomaly results (with glob for timestamped dirs)
        anomaly_patterns = [
        ...
        # Run epicenter detector
        output_file = f"results/epicenter_detection_{anomaly_type}.csv"

        cmd = [
            sys.executable,
            "epicenter_detector.py",
